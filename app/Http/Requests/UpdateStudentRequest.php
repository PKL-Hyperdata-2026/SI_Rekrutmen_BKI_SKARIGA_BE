...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $studentId = $studentParam instanceof StudentAlumni ? $studentParam->id : $studentParam;

        $userId = $studentParam instanceof StudentAlumni
            ? $studentParam->user_id
            : DB::table('students_alumni')->where('id', $studentId)->value('user_id');
    ...
    public function messages(): array
    {
        return [
            ...
            'nis.unique' => 'NIS sudah terdaftar pada data lain.',
